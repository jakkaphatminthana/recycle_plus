...
class _Member_MissionWeekState extends State<Member_MissionWeek> {
  ...
  Widget build(BuildContext context) {
    ...
    int nowOfWeek = now.weekday;
    DateTime fistdayOfWeek = now.subtract(Duration(days: nowOfWeek - 1));
    DateTime lastdayOfWeek =
        now.add(Duration(days: DateTime.daysPerWeek - now.weekday));

    String fistdaySTR = DateFormat('dd/MM/yyyy').format(fistdayOfWeek);
    String lastdaySTR = DateFormat('dd/MM/yyyy').format(lastdayOfWeek);

    final Stream<QuerySnapshot> _Mission_Week = FirebaseFirestore.instance
