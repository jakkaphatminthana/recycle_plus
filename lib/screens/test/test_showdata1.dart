...
class _Test1_listDataState extends State<Test1_listData> {
  // //TODO : where query
  // getData() async {
  //   CollectionReference productCL =
  //       FirebaseFirestore.instance.collection('test');

  //   await productCL.where("type", isEqualTo: "animal").get().then((value) {
  ...
  final TextEditingController SelectCategory = TextEditingController();
  bool isNFT = true;
  bool isLimited = true;
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: _TestStream.asBroadcastStream(),
